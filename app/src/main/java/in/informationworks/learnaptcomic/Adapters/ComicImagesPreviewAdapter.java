...
import in.informationworks.learnaptcomic.Activities.ComicImagesPreviewActivity;
...
public class ComicImagesPreviewAdapter extends PagerAdapter {
    ...
    ComicImagesPreviewActivity comicImagesPreviewActivity;



    public ComicImagesPreviewAdapter(ArrayList<String> image_resources,ArrayList<String> thumbImageResources, Context context,ComicImagesPreviewActivity comicImagesPreviewActivity) {
        this.image_resources = image_resources;
        this.thumbImageResources = thumbImageResources;
        this.context = context;
        this.comicImagesPreviewActivity = comicImagesPreviewActivity;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        item_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                comicImagesPreviewActivity.onPhotoViewClick();
            }
        });
