...
import in.informationworks.learnaptcomic.ComicImagePlayerActivity;
import in.informationworks.learnaptcomic.ComicImagePlayerActivity;
...
public class SingleComicCardViewHolder extends RecyclerView.ViewHolder {
    ...
    public SingleComicCardViewHolder(View itemView) {
        ...
        itemView.setOnClickListener(new View.OnClickListener(){
            ...
            {
                Intent intent = new Intent(v.getContext(), ComicImagePlayerActivity.class); v.getContext().startActivity(intent);
            }
